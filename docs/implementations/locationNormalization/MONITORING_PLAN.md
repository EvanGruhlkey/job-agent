...
> are relative to the repo root `<project-root>`.
>
...
- **Railway** — project `Careerbase` (`a69d8bf5-7235-4d56-afe3-c42f781ca437`);
  services `Careerbase` (`8239c326-b836-46c6-9181-cfb26b1ea0e6`) and
...
`8239c326-b836-46c6-9181-cfb26b1ea0e6` (`Careerbase`), project
...
- Reads **`MONITOR_DATABASE_URL`** (a *read-only* prod DSN) from the environment.
  ...
  *"Get the prod connection string from Railway → Careerbase → Postgres →
