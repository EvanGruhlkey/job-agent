...
```bash
git clone https://github.com/careerbase/Careerbase.git
cd Careerbase
```
...
These instructions work for IntelliJ IDEA Ultimate, PyCharm, and WebStorm. Open the project root (`Careerbase/`) as your project.
...
2. Configure:
   ...
   - **Working directory:** `<project-root>` (e.g., `/Users/you/Careerbase`)
